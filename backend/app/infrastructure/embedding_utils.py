"""
Embedding 工具函数 — 计算文本向量 + 余弦相似度

使用本地 OpenVINO 量化模型（granite-embedding-97m），纯 CPU 推理，无需网络。
"""
...
def _get_embedding_model():
    ...
    model_path = Path(__file__).resolve().parent.parent.parent / "models" / "granite-embedding-97m"
