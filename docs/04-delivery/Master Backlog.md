...
### Capability 3-A：长时间间隔恢复 □□□ 0%

| Story | 描述 | 状态 |
|-------|------|------|
| **S3.1** 间隔欢迎对话 | "好久不见。你上次学到这里"（不计数、不批评） | ⏳ |
| **S3.2** 从断点恢复 | 基于 Memory 定位上次学习位置 | ⏳ |
| **S3.3** Growth 展示"你离开期间的变化" | 中间缺失的时间段友好展示 | ⏳ |
