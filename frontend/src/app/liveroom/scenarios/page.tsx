        ...
        {showCreate && (
          <div className="mb-6 border border-[var(--color-border)] bg-[var(--color-card)] rounded-lg p-4 space-y-3">
            ...
            <textarea
              ...
              placeholder="场景描述 (可选)"
              className="w-full text-sm px-3 py-2 border border-[var(--color-border)] rounded bg-[var(--color-bg)] h-16 resize-none"
            />
            <textarea
              value={promptText}
            ...
            <textarea
              ...
              className="w-full text-sm px-3 py-2 border border-[var(--color-border)] rounded bg-[var(--color-bg)] h-20 resize-none"
            />
            <div className="flex gap-2">
              <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {scenarios.map((s) => (
              ...
              >
                ...
                {s.prompt_text && (
                  <div className="text-[10px] px-2 py-1 bg-emerald-50 border border-emerald-200 text-emerald-700 rounded mb-2">
                    {s.prompt_text}
                  </div>
                )}
