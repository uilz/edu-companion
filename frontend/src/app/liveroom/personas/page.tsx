        ...
        {showCreate && (
          <div className="mb-6 border border bg-surface rounded-lg p-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                <div className="text-[10px] text-muted">目标语言</div>
                <select
                  value={targetLanguage}
                  onChange={(e) => setTargetLanguage(e.target.value)}
                  className="w-full text-xs px-2 py-1.5 border border rounded bg-page"
                >
              ...
              <div>
                <div className="text-[10px] text-muted">熟练度</div>
                <select
                  value={proficiency}
              ...
              <div>
                <div className="text-[10px] text-muted">语速</div>
                <select
                  value={speechRate}
              ...
              <div>
                <div className="text-[10px] text-muted">行为</div>
                <select
                  value={behavior}
              ...
              >
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  {p.is_system ? (
                    ...
                    <span className="text-[10px] px-1.5 py-0.5 bg-accent/10 text-accent border border-accent/20 rounded">
                      自定义
                    </span>
                  )}
                </div>
                <div className="text-[10px] text-muted space-y-0.5">
                  ...
                  <div>纠错倾向: <strong className="text-success">
                    {CORRECTION_TENDENCY_LABELS[p.correction_tendency]}
                  </strong></div>
                </div>
                {p.personality && (
                  <div className="text-[10px] mt-2 text-muted line-clamp-2">
                    {p.personality}
                  </div>
                )}
              </div>
