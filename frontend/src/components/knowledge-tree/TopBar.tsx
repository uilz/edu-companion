...
export default function TopBar({
  ...
  return (
    <div className="flex flex-col flex-shrink-0 z-20 border-b border-[var(--color-border)] bg-[var(--color-surface)]">
      {/* ══ 第一行: 工具栏 ══ */}
      <div className="flex items-center gap-3 h-[48px] px-4">
        {/* 节点显示器：显示当前深入的节点名称 */}
        <div className="flex items-center gap-1.5 px-3 py-1.5 bg-[var(--color-page-secondary)] border border-[var(--color-border)] rounded-lg text-xs font-medium select-none">
      ...
      {focusRootId && breadcrumbs.length > 0 && (
        <div className="flex items-center gap-1.5 px-4 py-1.5 border-t border-[var(--color-border)]/50 bg-[var(--color-page-secondary)] text-[11px] text-[var(--color-text-muted)]">
