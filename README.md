...
苹果果是面向自主学习者的个人知识体系构建工具，覆盖**学习全生命周期**：
...
| 📁 **文件管理** | MarkItDown 解析 / TOC 索引 / 双区设计 / 对话 RAG / 练习生成 | ✅ v0.9.10 |
| 💡 **追问功能** | AI 回复下方 3 个递进式追问，点击即发送 | ✅ v0.9.11 |
...
# 预期返回：{"status":"ok","service":"苹果果学习助手","version":"0.1.0","db":true}
```
