...
| 模块 | 说明 | 提交 |
|------|------|:--:|
| SharedKnowledgeState | 对话+练习统一知识状态，双向融合 | 在提交中 |

### P0 收尾 (2026-05-18 完成)

| # | 任务 | 提交 |
|---|------|:--:|
| 1 | 引用溯源 `[[知识:xxx]]` | `deafe13` |
| 2 | 对话×练习联动 | `de7e700` |
| 3 | 对话树 PG 持久化 (6表) | `f6cb37e` |
| 4 | 搜索块（10平台） | 已有 |
| 5 | 心理陪伴加强 (11类情绪) | `a17fafa` |
| 6 | 前台资料页完善 (筛选/排序/批量/预览) | `8a64ec3` |
